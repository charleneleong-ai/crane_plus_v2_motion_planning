...
# Last Modified: Sunday, January 20th 2019, 12:11:57 am
...
ROS_PKG_PATH = rospkg.RosPack().get_path(
    'crane_plus_moveit_config') + '/scripts'
...
class Base(object):
    ...
    def _load_base_scene(self):
        """
        Loads the scene file into class
        """
    ...
    def add_base(self, timeout=4):
        ...
        self.scene.add_box(
            self.name, pose, (self.dim[0], self.dim[1], self.dim[2]))
